...
public class Activator {
	...
	public static void main(String[] args) {
		...
		File[] files = new File(
				"C:\\Users\\A\\Desktop\\code\\SemanticFlowGraph-main\\SemanticFlowGraph-main\\SemanticFlowGraph\\pshg")
				.listFiles();
		for (File file : files) {
			if (file.isFile()) {
				String statement = "";
				...
				try {
					...
					graph.toGraphVisText(fileindex,
							"C:\\Users\\A\\Desktop\\code\\SemanticFlowGraph-main\\SemanticFlowGraph-main\\SemanticFlowGraph\\pshg\\result");
				} catch (Exception e) {
